  ...
  <header class="md:hidden fixed top-0 left-0 right-0 z-40 transition-all duration-300 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800/50 shadow-sm">
    ...
    <div class="px-4 pb-3">
      <div class="relative group">
        ...
        <input type="text" x-model="search" placeholder="搜索..." autocomplete="off" class="w-full bg-gray-100 dark:bg-gray-800/80 text-gray-900 dark:text-gray-100 text-sm rounded-xl py-2 pl-9 pr-4 border-none ring-0 focus:ring-2 focus:ring-blue-500/50 placeholder-gray-400 transition-all duration-300 shadow-inner">
      </div>
    </div>
  </header>
    ...
    <div class="h-16 px-4 flex w-full items-center justify-between gap-4">
      ...
      <div class="flex flex-1 justify-center px-4 lg:px-8">
        <div class="max-w-2xl w-full relative">
          <input type="text" x-model="search" placeholder="搜索链接..." autocomplete="off" class="w-full bg-gray-100 dark:bg-gray-700/50 border-0 rounded-full py-2 pl-10 pr-4 focus:ring-2 focus:ring-blue-500/50 text-sm transition-all shadow-inner">
